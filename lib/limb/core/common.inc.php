 ...
 * @version    $Id: common.inc.php 4991 2007-02-08 15:35:35Z pachanga $
 * @package    core
 */
...
function lmb_find_limb_packages()
{
  return lmb_glob('limb/*');
}
...
{
  return str_replace('_', ' ', to_under_scores($str));
}
