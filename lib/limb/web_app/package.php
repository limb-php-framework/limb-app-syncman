 ...
 * @version    $Id: package.php 5101 2007-02-16 13:55:31Z serega $
 * @package    web_app
 */
...
$package->addPackageDepWithChannel('required', 'active_record', 'pear.limb-project.com', '0.2.0');
$package->addPackageDepWithChannel('required', 'classkit', 'pear.limb-project.com', '0.1.0');
$package->addPackageDepWithChannel('optional', 'cli', 'pear.limb-project.com', '0.1.0');
...
$package->addPackageDepWithChannel('required', 'i18n', 'pear.limb-project.com', '0.1.0');
$package->addPackageDepWithChannel('required', 'net', 'pear.limb-project.com', '0.1.0');
$package->addPackageDepWithChannel('required', 'session', 'pear.limb-project.com', '0.2.0');
...
$package->addPackageDepWithChannel('required', 'wact', 'pear.limb-project.com', '0.2.0');
