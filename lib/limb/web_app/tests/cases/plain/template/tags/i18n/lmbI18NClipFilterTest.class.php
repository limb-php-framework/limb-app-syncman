 ...
 * @version    $Id: lmbI18NClipFilterTest.class.php 5012 2007-02-08 15:38:06Z pachanga $
 * @package    web_app
 */
...
class lmbI18NClipFilterTest extends lmbWactTestCase
{
  ...
  function testPathBasedDBELengthLimit()
  {
    ...
    $my_dataspace = new lmbDataspace(array('var' => 'жириновский'));
