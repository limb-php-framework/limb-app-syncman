 ...
 * @version    $Id: lmbDynamicCommandController.class.php 5012 2007-02-08 15:38:06Z pachanga $
 * @package    web_app
 */
...
class lmbDynamicCommandController extends lmbAbstractController
{
  ...
  {
    $path = "src/command/" . $this->getName() . "/" . toStudlyCaps($this->getName() . '_' . $action) . "Command.class.php";
