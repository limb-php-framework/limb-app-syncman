 ...
 * @version    $Id: set.tag.php 5021 2007-02-12 13:04:07Z pachanga $
 * @package    wact
 */

require_once 'limb/wact/src/compiler/property/WactAttributeProperty.class.php';
...
class WactCoreSetTag extends WactCompilerTag
{
  function preParse()
  {
    ...
    foreach(array_keys($this->attributeNodes) as $key)
    {
      ...
      $property = new WactAttributeProperty($this->attributeNodes[$key]);
