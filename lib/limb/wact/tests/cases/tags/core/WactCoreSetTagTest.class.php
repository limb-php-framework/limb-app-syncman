 ...
 * @version    $Id: WactCoreSetTagTest.class.php 5021 2007-02-12 13:04:07Z pachanga $
 * @package    wact
 */
...
class WactCoreSetTagTest extends WactTemplateTestCase
{
  ...
  {
    $template = '<core:optional for="item1"><core:SET color="yellow" runtime></core:optional>'.
                '<core:optional for="item2"><core:SET color="green" runtime></core:optional>'.
                '{$color}';
