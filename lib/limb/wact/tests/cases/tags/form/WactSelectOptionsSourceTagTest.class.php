 ...
 * @version    $Id: WactSelectOptionsSourceTagTest.class.php 5021 2007-02-12 13:04:07Z pachanga $
 * @package    wact
 */
...
class WactSelectOptionsSourceTagTest extends WactTemplateTestCase
{
  ...
  function testOptionsViaRegisterDatasourceAndDefaultOption()
  {
    ...
    $this->assertEqual($page->capture(),
                       '<form>'.
                       '<select id="select" name="select"><option value="" selected>select</option><option value="4">red</option><option value="5">blue</option></select>'.
                       '</form>');
  }
