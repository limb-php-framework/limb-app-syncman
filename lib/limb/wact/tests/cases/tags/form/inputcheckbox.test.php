 ...
 * @version    $Id: inputcheckbox.test.php 5021 2007-02-12 13:04:07Z pachanga $
 * @package    wact
 */
...
class WactInputCheckboxComponentTestCase extends WactTemplateTestCase
{
  ...
  {
    $template = '<form id="testForm" runat="server">
                    <input type="checkbox" id="test" name="myInput" runat="server" checked>
                </form>';
