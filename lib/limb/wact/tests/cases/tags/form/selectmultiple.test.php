...
class WactSelectMultipleComponentTestCase extends WactTemplateTestCase
{
  function testGetValue()
  {
    $template = '<form id="testForm" runat="server">
                        <select id="test" name="multiple[]" runat="server" multiple></select>
                    </form>';
  ...
  */
  ...
  function testSelectUseOptionsListWithDefaultSelectedOption()
  {
    $template = '<form runat="server">'.
                  '<select id="test" name="mySelect[]" runat="server" multiple>'.
    ...
    $expected_template =
                '<form>'.
                  '<select id="test" name="mySelect[]" multiple>'.
                  '<option value="1" selected>&quot;test1&quot;</option>'.
                  '<option value="2">\&#039;test2\&#039;</option>'.
                  '<option value="3" selected>test3</option>'.
                  '</select>'.
