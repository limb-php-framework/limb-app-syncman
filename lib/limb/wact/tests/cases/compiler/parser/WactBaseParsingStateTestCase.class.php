 ...
 * @version    $Id: WactBaseParsingStateTestCase.class.php 5021 2007-02-12 13:04:07Z pachanga $
 * @package    wact
 */
...
class WactBaseParsingStateTestCase extends UnitTestCase
{
  ...
  function testInvalidAttributeSyntax()
  {
    ...
    {
      $this->assertWantedPattern('/Attribute syntax error array/', $e->getMessage());
    }
  }
}
