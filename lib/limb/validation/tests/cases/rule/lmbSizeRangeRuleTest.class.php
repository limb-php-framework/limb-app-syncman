 ...
 * @version    $Id: lmbSizeRangeRuleTest.class.php 5010 2007-02-08 15:37:40Z pachanga $
 * @package    validation
 */
...
class lmbSizeRangeRuleTest extends lmbValidationRuleTestCase
{
  ...
  function testSizeRangeRuleZero()
  {
    ...
    $this->error_list->expectOnce('addError', array(tr('/validation', '{Field} must be greater than {min} characters.'),
  ...
  function testSizeRangeRuleTooBig()
  {
    ...
    $this->error_list->expectOnce('addError', array(tr('/validation', '{Field} must be less than {max} characters.'),
                                                         array('Field'=>'testfield'),
                                                         array('max'=>10)));
