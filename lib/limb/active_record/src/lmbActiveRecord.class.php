 ...
 * @version    $Id: lmbActiveRecord.class.php 5020 2007-02-12 09:08:53Z pachanga $
...
class lmbActiveRecord extends lmbObject
{
  ...
  {
    return 'addTo' . toStudlyCaps($property);
  }
  /**
  ...
  function mapAddToProperty($method)
  {
    if(substr($method, 0, 5) == 'addTo')
      return to_under_scores(substr($method, 5));
  }
  /**
  ...
  {
    $params = array();
    if(is_object($magic_params) || is_string($magic_params))
  ...
  static function find($class_name, $magic_params = array())
  {
    ...
    elseif(is_int($magic_params))
      return lmbActiveRecord :: findById($class_name, $magic_params);
    elseif(!is_array($magic_params))
